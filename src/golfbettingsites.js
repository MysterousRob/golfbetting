  ...
  return (
    <div className='in-body'>
      ...
      <div className='nav'>
        ...
        <button href="C:\Users\rober\OneDrive\Desktop\Golf-betting\golfbetting\src\golfbettingsites.js" onClick= {() => console.log('Betting Sites button clicked')}><span>Betting Sites</span></button>
      </div>  
      </header>
      <div className='tips'>
